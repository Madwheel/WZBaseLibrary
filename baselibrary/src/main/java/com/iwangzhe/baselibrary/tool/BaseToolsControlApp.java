 ...
 * desc   :
 */
public class BaseToolsControlApp extends ControlApp {
    private BaseToolsMain mMain;

    public BaseToolsControlApp(BaseToolsMain main) {
        super(main);
        mMain = main;
    }

    private static BaseToolsControlApp mBaseToolsControlApp = null;

    public static BaseToolsControlApp getInstance(BaseToolsMain main) {
        synchronized (BaseToolsControlApp.class) {
            if (mBaseToolsControlApp == null) {
                mBaseToolsControlApp = new BaseToolsControlApp(main);
            }
        }
        return mBaseToolsControlApp;
    }
